...
TOKEN = "7011673585:AAFhmpxbfPwsg_kjrdeTxAkjF33cvFMF4gY"
...
def send_welcome(message):
    users = load_users()
    if str(message.from_user.id) in users or message.from_user.id == 7019866710: #ايديك
...
def handle_id(message):
    if message.from_user.id == 7019866710: #ايديك
